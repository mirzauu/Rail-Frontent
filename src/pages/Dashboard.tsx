  ...
  return (
    <div className="animate-fade-in p-2 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {[
          { title: "Active Agents", value: "4", change: "+1", icon: Bot, color: "text-primary", bg: "bg-primary/10" },
          { title: "Total Conversations", value: "1,248", change: "+12%", icon: MessageSquare, color: "text-purple-500", bg: "bg-purple-500/10" },
          { title: "Knowledge Assets", value: "843", change: "+24", icon: BookOpen, color: "text-amber-500", bg: "bg-amber-500/10" },
          { title: "System Health", value: "98.9%", change: "Stable", icon: Activity, color: "text-emerald-500", bg: "bg-emerald-500/10" },
        ].map((stat, i) => (
            ...
            <CardContent className="p-0 flex-1">
              ...
              <div className="p-3 border-t border-border/40 bg-muted/10">
                <Button variant="ghost" className="w-full text-xs text-muted-foreground hover:text-primary">
                  View full activity log <ArrowRight className="ml-1 h-3 w-3" />
                </Button>
              </div>
            </CardContent>
          </Card>
